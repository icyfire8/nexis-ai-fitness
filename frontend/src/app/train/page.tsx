...
const LIGHT_PROTOCOL = [
  ...
  { name: "Plank Hold", duration: 30, image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=800&auto=format&fit=crop" },
...
const HEAVY_PROTOCOL = [
  ...
  { name: "Weighted Plank", duration: 60, image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=800&auto=format&fit=crop" },
  ...
  { name: "Burpees", duration: 45, image: "https://images.unsplash.com/photo-1517963879433-6ad2b056d712?q=80&w=800&auto=format&fit=crop" }
];
            ...
            <>
              ...
              <div className="grid grid-cols-4 md:grid-cols-12 gap-6">
                ...
                <div className="col-span-4 md:col-span-6 bg-surface-container/70 backdrop-blur-[20px] rounded-xl border border-outline-variant p-6 relative shadow-[0_4px_16px_rgba(0,0,0,0.4)] flex flex-col justify-center items-center text-center">
                  ...
                  <span className="font-numeric-data text-[56px] leading-none text-on-surface tracking-tighter drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">6</span>
                </div>
